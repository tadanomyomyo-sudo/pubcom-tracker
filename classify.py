...
- 安全網ルール：カテゴリーが「防衛」「外事」「選挙、政党」のいずれかである案件は、
  タイトルが一見地味な人事・手続き的な内容（休暇規定、兼業規則、旅費規程など）
  であっても、基準1・2・3・8のいずれかに実質的に関わる可能性を広めに見て
  「該当」寄りに判定してください（防衛体制・外交・選挙制度の整備自体が
  関心領域の対象であるため）。ただし、あなたが判断して有権的に無関係な単純な
  庶務規定だと確信できる場合は除外してかまいません。
